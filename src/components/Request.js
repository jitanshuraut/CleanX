...
export default function Request() {
    ...
    const [alr, setalr] = useState("0px")
    const history = useNavigate();
    const ref = collection(db, "Request_to_Clean_Area");
    const save = async () => {
        await addDoc(ref, { name: name, email: email, message: message, location: location, phonenumber: phone })
